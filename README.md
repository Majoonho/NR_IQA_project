...
[NR-IQA자료조사](https://tasteful-blouse-0e2.notion.site/NR-IQA-1bfd2f12e3c24cf79a2f531b079f2b44)
##### (자료조사목차 : Dectection --> IQA 란? --> 논문(Mean Opinion Score: MOS)이 실제 사용되는가? --> <br/>평가지표(ROCC/LCC) --> NR-IQA metric --> NR-IQA source-code)
...
# NR_IQA (No Reference Image Quality Assessment)
  ...
  * 결과 : 개별최대 ROCC 0.869  앙상블 ROCC 0.922 상승!<br/>Metric 간의 단점을 서로 보완해주어, 실제로도 더 좋은 결과를 만들어 내었음 <br/> --> 세밀한 모델을 만든다면, 더 좋은 결과가 예상되어집니다.
